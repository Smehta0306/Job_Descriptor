...
Sal_template = PromptTemplate(
    input_variables = ['job_title'], 
    template='Generate the average salary for the {job_title} just the number'
)
Questions_template = PromptTemplate(
    input_variables = ['technical_skills'], 
    template='Generate three frequently asked questions in an interview for each of the technical skills in {technical_skills} '
)
